...
function ContactUsSection1() {
  // contact section 1 main compnent 
  return (
    <Box className="contactUsSection1 d-flex justify-content-center align-items-center" sx={{height:{xs:"100vh",lg:"500px"},mt:{xs:10,lg:10},flexDirection:"column",color:"#F2F2F2",mb:{xs:"650px",lg:"700px"}}}> 
